...
To use the RichFaces framework in your JSF maven application, simply add the following dependency to your `pom.xml` file (Replacing the version `4.5.17-gluu.Final` with the version of the library you wish to include):
...
<dependency>
    ...
    <version>4.5.17-gluu.Final</version>
</dependency>
----
